...
- **Roadmap webinars**: Filter the webcast catalog by “Roadmap” to see upcoming platform briefings (https://resources.github.com/webcasts/?event-topic=Roadmap).
...
- **Adoption kits**: Use the adoption guides library to pull role-based checklists and rollout plans (https://resources.github.com/guides/).
