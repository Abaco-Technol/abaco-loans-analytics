...
3. Triage: Compare contract vs incoming schema; identify new/missing/renamed fields or changed data types; check source change logs.
4. Fix: Map new fields, update contracts and transformation logic, bump version; add defaults/backfill where safe; coordinate with source and consumer owners.
